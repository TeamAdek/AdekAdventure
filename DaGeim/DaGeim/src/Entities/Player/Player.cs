...
namespace RobotBoy.Entities.Player
{
    internal sealed class Player : Entity, ICollecting, IJumpboostable
    {
        ...
        {
            entityTexture = content.Load<Texture2D>("SpriteSheets/PlayerAnimation");
            rocketLeft = content.Load<Texture2D>("Ammunition/RocketLeft");
            rocketRight = content.Load<Texture2D>("Ammunition/RocketRight");
