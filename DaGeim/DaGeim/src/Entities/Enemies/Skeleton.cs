...
namespace RobotBoy.Entities.Enemies
{
    internal sealed class Skeleton : NPC
    {
        ...
        {
            entityTexture = content.Load<Texture2D>("SpriteSheets/Skeleton");
            ammoLeft = content.Load<Texture2D>("Ammunition/IcycleLeft");
            ammoRight = content.Load<Texture2D>("Ammunition/IcycleRight");
